...
class MY_Model extends CI_Model
{
    ...
    /*
     * commented only for developing purposes to see a basic structure of the data
      protected $_cols = array(
      'groupsID' => array(
      'column_name' => 'GROUPS_ID',
      ),
      'attributeID' = array(  // relace, kde je na tento zaznam v jine tabulce pouze jeden zaznam
      'column_name' => 'ATTRIBUTE_ID',
      'relationship' => array(
      'type' => 'has_one',
      'table' => '',
      'class' => 'nazev classy',  // presny nazev classy tak jak je deklarovana
      ),
      'value' => instance objektu  // tento radek je pouze informativni, v deklaraci classy nebude!
      )
      'label' => array(
      'column_name' => 'LABEL'
      ),
    ...
    /*
      ...
      'attributes' => array(
      'table' => 'ATTRIBUTES',
      'class' => 'Attribute',  // presny nazev classy tak jak je deklarovana
      ),
      'dalsi vazba' => array()
      'table' => '',
      'class' => '',  // presny nazev classy tak jak je deklarovana
      ),
      );
     */
    ...
    public function __set($sAttributeName, $mValue)
    {
        ...
        if (array_key_exists($sAttributeName, $this->_cols)) {
            ...
            /*
              if (isset($this->_cols[$sAttributeName]['type'])) {
              $retyped = $this->_cols[$sAttributeName]['value'];
              settype($retyped, $this->_cols[$sAttributeName]['type']);
              $this->_cols[$sAttributeName]['value'] = $retyped;
              }
             */
            return;
        } else {
     ...
     * @author Roman Brunda
     * @since  30/06/2011 - Patrik Nejezhleb <p.nejezchleb@pixvalley.com> - changed dont_save checking
     * @access Public
     * @param void
     ...
     * @author Jan Jablunka <j.jablunka@pixvalley.com>
     * @access public
     * @param  array $aParams
     * @return bool
     */
     ...
     * @author Petr Simek
     * @since  22/06/2011 - Patrik Nejezhleb - added param $iOrganisationId
     * @access Public
     ...
     * @author  Petr Jurasek <p.jurasek@pixvalley.com>
     * @access  protected
     * @param   integer $id
     * @param   stirng $table
     ...
     * @author Andrej Fakras <a.farkas@pixvalley.com>
     * @param array $aFilter
     */
